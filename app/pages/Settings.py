...
def display_settings():
    ...
    repeat_current_password = col2.text_input(
        "Repeat Current Password", type="password"
    )
    ...
    new_profile_picture = col4.file_uploader(
        "Upload New Profile Picture", type=["jpg", "jpeg", "png"]
    )
    ...
    if st.button("Save Changes"):
        ...
        if (
            ...
            and current_password == repeat_current_password
            and current_email == repeat_current_email
        ):
